...
import com.example.m5_hw.DBHandler;
import com.example.m5_hw.database.Student;
import com.example.m5_hw.utils.MyDividerItemDecoration;
import com.example.m5_hw.utils.RecyclerTouchListener;

public class MainActivity extends AppCompatActivity {
    private WaitingList mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new WaitingList(this, student);
    ...
    private void createItemDialog(final Student item, final int position) {
        ...
        // For create new item
        View view = layoutInflaterAndroid.inflate(R.layout.new_item, null);
        ...
        dialogTitle.setText(getString(R.string.new_option));
    ...
    private void setPriorityDialog(final Student item, final int position) {
        ...
        TextView dialogTitle = view.findViewById(R.id.dialog_title);
        dialogTitle.setText(getString(R.string.set_option));
    ...
    private void editItemDialog(final Student item, final int position){
        ...
        View view = layoutInflaterAndroid.inflate(R.layout.edit, null);
        ...
        TextView dialogTitle = view.findViewById(R.id.dialog_title);
        dialogTitle.setText(getString(R.string.edit_label));
